...
public:
  ...
  // mat times vector
  friend Vec2 operator*(const Matrix2x2& m, const Vec2& v);
  // vector times mat
  friend Vec2 operator*(const Vec2& v, const Matrix2x2& m);
  // outer product
  friend Matrix2x2 operator&(const Vec2& v1, const Vec2& v2);
};
...
public:
  ...
  // vector times mat
  friend Vec3 operator*(const Vec3& v, const Matrix3x3& m);
  // outer product
  friend Matrix3x3 operator&(const Vec3& v1, const Vec3& v2);
};
...
public:
  ...
  // mat times vector
  friend Vec4 operator*(const Matrix4x4& m, const Vec4& v);
  // vector times mat
  friend Vec4 operator*(const Vec4& v, const Matrix4x4& m);
  // outer product
  friend Matrix4x4 operator&(const Vec4& v1, const Vec4& v2);
};
